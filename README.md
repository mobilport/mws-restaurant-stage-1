...
Alternatively, you can use http-server, which can be downloaded via npm: 'npm install http-server -g', and can run as 'http-server -p 8080' in project root folder (where index.html can be found)
About http-server read more: https://www.npmjs.com/package/http-server
